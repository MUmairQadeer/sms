              ...
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                  ...
                  <li class="nav-item menu">
                      ...
                      <ul class="nav nav-treeview ">
                          <li class="nav-item ">
                              <a href="<?=$site_url?>admin/userAcc.php?user=counseller" class="nav-link ">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Counseller</p>
                              </a>
                          </li>
                          <li class="nav-item ">
                              <a href="<?=$site_url?>admin/userAcc.php?user=teacher" class="nav-link ">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Teachers</p>
                              </a>
                          </li>
                          <li class="nav-item">
                              <a href="<?=$site_url?>admin/userAcc.php?user=student" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Student</p>
                              </a>
                          </li>
                          <li class="nav-item">
                              <a href="<?=$site_url?>admin/userAcc.php?user=parent" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Parent</p>
                              </a>
                          </li>
                          <li class="nav-item">
                              <a href="<?=$site_url?>admin/userAcc.php?user=librarian" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Librarian</p>
                              </a>
                          </li>
               ...
               <li class="nav-item menu">
                      ...
                      <ul class="nav nav-treeview">
                          ...
                          <li class="nav-item">
                              <a href="<?=$site_url?>admin/cources.php" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Cources</p>
                              </a>
                          </li>
                          ...
                          <li class="nav-item">
                              <a href="<?=$site_url?>admin/lesson.php" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Lessons</p>
                              </a>
                          </li>
               ...
               <li class="nav-item menu">
                      ...
                      <ul class="nav nav-treeview">
                          <li class="nav-item">
                              <a href="/student-feekk.php" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>teacher</p>
                              </a>
                          </li>
