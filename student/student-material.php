            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        $class =get_usermeta($std_id,'class');
                                        $count =1;
                                $query =mysqli_query($db_conn, "SELECT * FROM `posts`
                                as p JOIN `metadata` as m ON p.id =m.item_id WHERE 
                                p.type ='study-material' AND m.meta_key ='class'
